...
|----------------------|------------------------------------------------|---------------|-----------| ----------------|------------|---------|------------|
| IFC4.3AbRV_E3_EWFL   | Earthworks Fill                                | E3            | EWFL      | Alex Bradley    | ABCon.Tech | 1.0     | 24.01.2022 |
...
This test case addresses the import and export of earthworks fill entities between various domains within the Earthworks exchange. 
